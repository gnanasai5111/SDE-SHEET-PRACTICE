...
Similar approach as house robber 1. The only difference is you wont consider the last element in one case, and you wont consider the first 
element in other case .You find the max Of Both.
